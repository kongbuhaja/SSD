...
if custom_dataset_dir:
    train_data, info = data_utils.get_custom_dataset("custom_dataset", "train", custom_dataset_dir)
    val_data, _ = data_utils.get_custom_dataset("custom_dataset", "test", custom_dataset_dir)
...
default_boxes = bbox_utils.generate_default_boxes(hyper_params["feature_map_shapes"], hyper_params["aspect_ratios"])
ssd_train_feed = train_utils.generator(train_data, default_boxes, hyper_params)
ssd_val_feed = train_utils.generator(val_data, default_boxes, hyper_params)
