...
if custom_dataset_dir:
    test_data, info = data_utils.get_custom_dataset("custom_dataset", "test", custom_dataset_dir)
...
prior_boxes = bbox_utils.generate_default_boxes(hyper_params["feature_map_shapes"], hyper_params["aspect_ratios"])
